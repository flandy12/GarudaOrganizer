        ...
        loading === false ? (
            ...
            <div className="bg-black">
                <div className="bg-outside-2 z-0 opacity-50 text-white relative" style={divStyle}> </div>
                    ...
                    <h1 className="font-semibold xl:text-4xl lg:text-4xl md:text-4xl text-2xl">Digital Services</h1>
                    ...
                    <div className="py-10 border-b-2 border-blue-500 w-max">
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <div className="flex items-center">
                                ...
                                <Link to="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 ">Service</Link>
                            </div>
                            </li>
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Digital Services</span>
                            </div>
                            </li>
                        </ol>
                        </nav>
