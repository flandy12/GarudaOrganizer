              ...
              loading === false ? (
                ...
                <div className="flex overflow-hidden relative flex-col justify-center items-center self-stretch px-16 py-12 w-full min-h-[500px] max-md:px-5 max-md:max-w-full">
                    <picture>
                        ...
                        <img className="object-cover absolute inset-0 size-full" src={`${banner}`} alt="MICE" loading="lazy" />
                    </picture> 
                ...
                <div className="container mx-auto">
                    ...
                    <div className="flex flex-col grow place-content-center max-md:max-w-full">
                        <span className={`justify-center text-center self-start w-[150px] px-5 py-2 font-bold text-white whitespace-nowrap rounded-3xl border border-blue-300 border-solid capitalize bg-cs ${title === 'null' ? 'hidden' : ''}`}>
                        {title}
                        </span>
                    ...
                    <picture>
                        ...
                        <img className="w-full aspect-[1.61] max-md:max-w-full" src={image} alt="MICE" loading="lazy" />
                    </picture> 
                    </div>
                </div>
                </div>
                                        ...
                                        {other_images.length > 0 ? (
                                            other_images.map((value,keys) => (
                                                ...
                                                <picture >
                                                    ...
                                                    <img className={`h-full object-cover ${hover_element === 'element-'+keys ? 'opacity-55' : ''} `} src={`${value.image}`} alt="MICE" loading="lazy" data-target={`element-${keys}`}/>
                                                </picture> 
